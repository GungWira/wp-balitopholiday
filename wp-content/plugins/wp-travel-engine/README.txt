...
= 6.7.1 - 13th January 2026 =

* Improved: Addressed minor issues in manual bookings.
* Improved: Updated the booking flow to better support the installment payments add-on.
* Fixed: Resolved an issue where canceled bookings were incorrectly shown in the upcoming tour bookings list.
* Fixed: Discount amounts now display correctly with consistent formatting across all trip prices.
* Fixed: Corrected layout and styling issues when using right-to-left (RTL) languages.
